  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:ring-2 focus-visible:ring-[var(--color-accent-blue)] focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded-lg",
        className
      )}
    ...
    >
      ...
      <span className="font-[var(--font-outfit)] text-[11px] text-white/40 truncate max-w-[80px]">
        {username}
      </span>
    </button>
  );
...
function StoryViewerModal({
  ...
  const handlePointerDown = React.useCallback((e: React.PointerEvent) => {
    // Don't pause when clicking buttons in the header controls
          ...
          <div className="flex items-center justify-between px-4 mt-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-white text-sm font-medium font-[var(--font-outfit)]">{username}</span>
                {timestamp && (
                  <span className="text-white/60 text-xs font-[var(--font-outfit)]">
            ...
            <div className="flex items-center gap-2">
              {isPaused && (
                <div className="flex items-center gap-1 text-white/80">
                  ...
                  <span className="text-xs font-[var(--font-outfit)]">Paused</span>
                </div>
              )}
