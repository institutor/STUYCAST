...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
  ...
  return (
    ...
    >
      {/* Base text layer */}
      <span className="text-5xl font-bold tracking-tighter text-white tracking-wide">{text}</span>
      ...
      >
        ...
        >
          <span className="text-5xl font-bold tracking-tighter text-black whitespace-nowrap tracking-wide">
            {hoverText}
          </span>
        </div>
      </div>
