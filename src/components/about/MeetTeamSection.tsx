...
const roster: PersonInfo[] = [
  ...
  { name: "Jiewen Huang", roles: ["Board", "Director"], permission: 3, bio: "Class of '26", photo: "/team/jiewen-huang.jpg", crews: ["Vice President", "Web Development"], customTitle: "VP of Web Development" },
